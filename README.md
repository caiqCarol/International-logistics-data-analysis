...
关键字段： `order_id`, `order_date`, `customer_type`, `transport_mode`, `origin_city`, `destination_country`
, `weight_kg`, `volume_cbm`, `promised_days`, `actual_days`, `delay_flag`
, `shipping_cost`, `customs_cost`, `warehouse_cost`, `total_cost`, `revenue`, `profit`, `profit_margin`
